(function() {
    ...
    (function() {
        function Aa() {
            function a() {
                if (!a.Ac) la = a.Ac = m, ma = D, c.a(F, function(a) {
                    a.nc()
                })
            }
            ...
            if (w.addEventListener) "complete" === w.readyState ? a() : w.addEventListener("DOMContentLoaded", a, D);
                ...
                w.documentElement.doScroll && d && b()
            }
            c.Rb(o, "load", a, m)
        }
        ...
        function Ba() {
            y.init = function(a, b, d) {
                ...
                else if (a) d = S(a, b, "mixpanel"), d.ja(), F.mixpanel = d;
                y = d;
                1 === ca && (o.mixpanel = y);
                Ca()
            }
        ...
        function S(a, b, d) {
            ...
            if (h && 0 === ca) f = h;
                ...
                if (h && !c.isArray(h)) {
                    s.error("You have already initialized " + d);
                    return
                }
                f = new e
            }
            ...
            J = J || f.c("debug");
            !c.g(h) && c.isArray(h) && (f.za.call(f.people, h.people), f.za(h));
            return f
        }
        ...
        function n(a) {
            ...
            var b = a.persistence;
            if ("cookie" !== b && "localStorage" !== b) s.H("Unknown persistence type " + b + "; falling back to cookie"), b = a.persistence = "cookie";
            this.i = "localStorage" ===
                b && c.localStorage.ra() ? c.localStorage : c.cookie;
            this.load();
            this.hc(a);
            this.sd(a);
            this.save()
        ...
        function C(a, b) {
            ...
            this.oa = this.A.batch_flush_interval_ms;
            this.ua = !this.A.batch_autostart;
            this.Ia = 0;
            this.F = {}
        }
        ...
        function ta(a, b) {
            if (Ka(b)) return s.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'), m;
            var d = "0" === V(b).get(W(a, b));
            d && s.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data.");
            return d
        }
        ...
        function La(a, b) {
            b = b || {};
            V(b).remove(W(a, b), !!b.wb, b.ub)
        }

        function V(a) {
            a = a || {};
            return "localStorage" === a.Ob ? c.localStorage : c.cookie
        }
        ...
        function sa(a, b, d) {
            !c.Va(b) || !b.length ? s.error("gdpr." + (a ? "optIn" : "optOut") + " called with an invalid token") : (d = d || {}, V(d).set(W(b, d), a ? 1 : 0, c.Hb(d.vb) ? d.vb : q, !!d.wb, !!d.Vc, !!d.xc, d.ub), d.o && a && d.o(d.ld || "$opt_in", d.md, {
                send_immediately: m
            }))
        }
            ...
            return function() {
                ...
                try {
                    var c = b.call(this, "token"),
                        ...
                        p = b.call(this, "opt_out_tracking_cookie_prefix"),
                    ...
                    s.error("Unexpected error when checking tracking opt-out status: " + e)
                }
        ...
        var B = Array.prototype,
            ...
            s = {
                ...
                warn: function() {
                    if (J && !c.g(z) && z) {
                        var a = ["Mixpanel warning:"].concat(c.N(arguments));
                        try {
                            z.warn.apply(z, a)
                        } catch (b) {
                            c.a(a, function(a) {
                ...
                error: function() {
                    if (J && !c.g(z) && z) {
                        var a = ["Mixpanel error:"].concat(c.N(arguments));
                        try {
                            z.error.apply(z, a)
                        } catch (b) {
                            c.a(a, function(a) {
        ...
        c.N = function(a) {
            return !a ? [] : a.N ? a.N() : c.isArray(a) || c.Ic(a) ? K.call(a) : c.ud(a)
        };
        ...
        c.La = function(a) {
            c.a(a, function(b, d) {
                c.Jc(b) ? a[d] = c.Cc(b) : c.e(b) && (a[d] = c.La(b))
            });
            return a
        };
                    ...
                    switch (typeof t) {
                        ...
                        case "object":
                            ...
                            g +=
                                "    ";
                            r = [];
                            if ("[object Array]" === Q.apply(t)) {
                                i = t.length;
                                for (p = 0; p < i; p += 1) r[p] = b(p, t) || "null";
                                return i = 0 === r.length ? "[]" : g ? "[\n" + g + r.join(",\n" + g) + "\n" + e + "]" : "[" + r.join(",") + "]"
                            }
                            for (p in t) X.call(t, p) && (i = b(p, t)) && r.push(d(p) + (g ? ": " : ":") + i);
                        ...
                        a: {
                            ...
                            if ("{" === i) {
                                ...
                                for (; i;) {
                                    ...
                                    b();
                                    h(":");
                                    Object.hasOwnProperty.call(k, e) && g('Duplicate key "' + e + '"');
                                    k[e] = t();
                                    b();
                                    if ("}" === i) {
                                        h("}");
        ...
        c.vc = function(a) {
            ...
            if (!a) return a;
            a = c.td(a);
            do b = a.charCodeAt(g++), d = a.charCodeAt(g++), f = a.charCodeAt(g++), h = b << 16 | d << 8 | f, b = h >> 18 & 63, d = h >> 12 & 63, f = h >> 6 & 63, h &= 63, e[p++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b) +
        ...
        c.hb = function() {
            ...
            function b() {
                var a = 1 * new Date,
                    b;
                if (o.performance &&
                    o.performance.now) b = o.performance.now();
                else
        ...
        c.Pa = function(a, b) {
            ...
            try {
                ...
                s.error("Skipping decoding for malformed query param: " +
                    c)
            }
            return c.replace(/\+/g, " ")
        };
        c.cookie = {
            get: function(a) {
                for (var a = a + "=", b = w.cookie.split(";"), c = 0; c < b.length; c++) {
                    for (var f = b[c];
            ...
            parse: function(a) {
                var b;
                try {
                    b = c.R(c.cookie.get(a)) || {}
                } catch (d) {}
                return b
            },
            zd: function(a, b, c, f, h, g, e) {
                var i = "",
                    k = "",
                    r = "";
                e ? i = "; domain=" + e : f && (i = (i = ra(w.location.hostname)) ? "; domain=." + i : "");
                c && (k = new Date, k.setTime(k.getTime() + 1E3 * c), k =
                    "; expires=" + k.toGMTString());
                g && (h = m, r = "; SameSite=None");
                h && (r += "; secure");
                w.cookie = a + "=" + encodeURIComponent(b) + k + "; path=/" + i + r
            },
        ...
        c.localStorage = {
            ra: function(a) {
                (a = U(q, a)) || s.error("localStorage unsupported; falling back to cookie store");
                return a
            },
            error: function(a) {
                s.error("localStorage error: " + a)
            },
            get: function(a) {
                try {
            ...
            parse: function(a) {
                try {
                    return c.R(c.localStorage.get(a)) || {}
                } catch (b) {}
                return q
            },
            set: function(a, b) {
        ...
        c.Rb = function() {
            ...
            return function(b, c, h, g, e) {
                b ? b.addEventListener && !g ? b.addEventListener(c, h, !!e) : (c = "on" + c, b[c] = a(b, h, b[c])) : s.error("No valid element provided to register_event")
            }
        }();
        var Na = /^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/;
        c.zc = function() {
            ...
            function b(b) {
                ...
                for (i = 0; i < b.length; i++)
                    if (d = b[i].replace(/^\s+/, "").replace(/\s+$/, ""), -1 < d.indexOf("#")) {
                        g = d.split("#");
                        d = g[0];
                        x = w.getElementById(g[1]);
                        if (!x || d && x.nodeName.toLowerCase() != d) return [];
                        x = [x]
                    } else if (-1 < d.indexOf(".")) {
                    g = d.split(".");
                    d = g[0];
                    ...
                    d || (d = "*");
                    g = [];
                    for (k = e = 0; k < x.length; k++) {
                        t = "*" == d ? x[k].all ? x[k].all : x[k].getElementsByTagName("*") : x[k].getElementsByTagName(d);
                        for (r = 0; r < t.length; r++) g[e++] = t[r]
                    }
                    x = [];
                    for (k = d = 0; k < g.length; k++) g[k].className && c.Va(g[k].className) && a(g[k], u) && (x[d++] = g[k])
                    ...
                    x = [];
                    for (k = d = 0; k < g.length; k++) u(g[k]) &&
                        (x[d++] = g[k])
                } else {
                    g = [];
                    for (k = e = 0; k < x.length; k++) {
                        t = x[k].getElementsByTagName(d);
                        for (r = 0; r < t.length; r++) g[e++] = t[r]
                    }
                    x = g
                }
            ...
            var d = /[\t\r\n]/g;
            return function(a) {
                return c.Kc(a) ? [a] : c.e(a) && !c.g(a.length) ? a : b.call(this, a)
            }
        }();
        ...
        c.info = {
            ...
            Lc: function() {
                return c.extend(c.info.X(), c.info.tb())
            },
            Tc: function(a) {
            ...
            Uc: function(a) {
                var b = c.info.Tc(a),
                    d = {};
                if (b !== q) d.$search_engine = b, a = c.Pa(a, "yahoo" != b ? "q" : "p"), a.length && (d.mp_keyword = a);
                return d
            },
            la: function(a, b, d) {
                return d || c.j(a, " OPR/") ? c.j(a, "Mini") ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test(a) ? "BlackBerry" : c.j(a, "IEMobile") || c.j(a, "WPDesktop") ? "Internet Explorer Mobile" : c.j(a, "SamsungBrowser/") ? "Samsung Internet" : c.j(a, "Edge") || c.j(a, "Edg/") ? "Microsoft Edge" : c.j(a, "FBIOS") ? "Facebook Mobile" : c.j(a, "Chrome") ? "Chrome" : c.j(a, "CriOS") ? "Chrome iOS" : c.j(a, "UCWEB") || c.j(a, "UCBrowser") ? "UC Browser" : c.j(a, "FxiOS") ? "Firefox iOS" : c.j(b || "", "Apple") ? c.j(a, "Mobile") ? "Mobile Safari" : "Safari" :
                    c.j(a, "Android") ? "Android Mobile" : c.j(a, "Konqueror") ? "Konqueror" : c.j(a, "Firefox") ? "Firefox" : c.j(a, "MSIE") || c.j(a, "Trident/") ? "Internet Explorer" : c.j(a, "Gecko") ? "Mozilla" : ""
            },
            Ha: function(a, b, d) {
                b = {
            ...
            $: function(a) {
                "object" !== typeof a && (a = {});
                return c.extend(c.ea({
                    $os: c.info.Lb(),
                    $browser: c.info.la(A, I.vendor, Y),
                    $referrer: w.referrer,
                    $referring_domain: c.info.Qb(w.referrer),
                    $device: c.info.Ab(A)
                }), {
                    $current_url: c.info.Ka(),
                    $browser_version: c.info.Ha(A, I.vendor, Y),
            ...
            Pc: function() {
                return c.extend(c.ea({
                    ...
                    $browser_version: c.info.Ha(A,
                        I.vendor, Y)
                })
            },
            Mc: function() {
                return c.ea({
                    current_page_title: w.title,
        ...
        c.JSONDecode = c.R;
        c.isBlockedUA = c.Gb;
        c.isEmptyObject = c.qa;
        c.info =
            c.info;
        c.info.device = c.info.Ab;
        c.info.browser = c.info.la;
        c.info.browserVersion = c.info.Ha;
        c.info.properties = c.info.$;
        ...
        E.prototype.o = function(a, b, d, f) {
            var h = this,
                g = c.zc(a);
            if (0 === g.length) s.error("The DOM query (" + a + ") returned 0 elements");
            else return c.a(g, function(a) {
                c.Rb(a, this.Mb, function(a) {
                    var c = {},
                        g = h.na(d, this),
                        e = h.Ib.c("track_links_timeout");
                    h.Na(a, this, c);
                    window.setTimeout(h.dc(f,
                        g, c, m), e);
                    h.Ib.o(b, g, h.dc(f, g, c))
                })
            }, this), m
        };
        E.prototype.dc = function(a, b, c, f) {
            var f = f || D,
                h = this;
            return function() {
                if (!c.wc) c.wc = m, a && a(f, b) === D || h.Fa(b, c, f)
            }
        };
        ...
        c.Fb(L, E);
        L.prototype.na = function(a, b) {
            var c = L.hd.na.apply(this, arguments);
            if (b.href) c.url = b.href;
            return c
        };
        L.prototype.Na = function(a, b, c) {
            c.Jb = 2 === a.which || a.metaKey || a.ctrlKey || "_blank" === b.target;
            c.href = b.href;
            c.Jb || a.preventDefault()
        };
        L.prototype.Fa = function(a,
            b) {
            b.Jb || setTimeout(function() {
        ...
        var Qa = ga("lock");
        qa.prototype.gb = function(a, b, c) {
            function f() {
                j.setItem(s, "1");
                try {
                    a()
                } finally {
                    j.removeItem(s), j.getItem(o) === k && j.removeItem(o), j.getItem(n) === k && j.removeItem(n)
                }
            }
            ...
            function i(a) {
                (new Date).getTime() - r > u ? (Qa.error("Timeout waiting for mutex on " + t + "; clearing lock. [" + k + "]"), j.removeItem(s), j.removeItem(o), h()) : setTimeout(function() {
                    try {
                        a()
                    } catch (c) {
                        b && b(c)
        ...
        G.prototype.Ma = function(a, b, d) {
            ...
            this.Wa.gb(c.bind(function() {
                var b;
                try {
                    var c = this.ca();
                    c.push(f);
                    (b = this.Za(c)) && this.G.push(f)
                } catch (e) {
            ...
            if (b.length < a) {
                ...
                if (d.length) {
                    ...
                    for (var h = 0; h < d.length; h++) {
                        var g = d[h];
                        if ((new Date).getTime() > g.flushAfter && !f[g.id] && (g.Oc = m, b.push(g), b.length >= a)) break
                    }
                }
            }
            return b
        };
        G.prototype.Qc = function(a, b) {
            var d = {};
            c.a(a, function(a) {
                d[a] = m
            });
            ...
            var f = c.bind(function() {
                ...
                try {
                    var c = this.ca(),
                        c = oa(c, d);
                    if (b = this.Za(c))
                        for (var c = this.ca(), f = 0; f < c.length; f++) {
                            var e =
                                c[f];
        ...
        G.prototype.ca = function() {
            var a;
            try {
                if (a = this.i.getItem(this.M)) a = aa(a), c.isArray(a) || (this.h("Invalid storage entry:", a), a = q)
            } catch (b) {
        ...
        G.prototype.Za = function(a) {
            try {
                return this.i.setItem(this.M, $(a)), m
            } catch (b) {
        ...
        C.prototype.stop = function() {
            this.ua = m;
            if (this.bb) clearTimeout(this.bb), this.bb = q
        };
        ...
        C.prototype.da = function() {
            this.Vb(this.A.batch_flush_interval_ms)
        };
        C.prototype.Vb = function(a) {
            this.oa = a;
            if (!this.ua) this.bb = setTimeout(c.bind(this.flush, this), this.oa)
        };
        C.prototype.flush = function(a) {
            try {
                if (this.Tb) R.log("Flush: Request already in progress");
                else {
                    var a = a || {},
                    ...
                    if (1 >
                        ...
                        var i = c.bind(function(e) {
                                ...
                                try {
                                    var g = D;
                                    if (a.fc) this.aa.rd(p);
                                    else if (c.e(e) && "timeout" === e.error && (new Date).getTime() - d >= b) this.h("Network timeout; retrying"), this.flush();
                                    else if (c.e(e) && e.Q && (500 <= e.Q.status || 429 === e.Q.status || "timeout" === e.error)) {
                                        var i = 2 * this.oa,
                                            k = e.Q.responseHeaders;
                                        if (k) {
                                            var j = k["Retry-After"];
                                        ...
                                        this.Vb(i)
                                    } else if (c.e(e) && e.Q && 413 === e.Q.status)
                                        if (1 < h.length) {
                                            var r =
                                                Math.max(1, Math.floor(f / 2));
                                            this.C = Math.min(this.C, r, h.length - 1);
                                            this.h("413 response; reducing batch size to " + this.C);
                                            this.da()
                                        } else this.h("Single-event request too large; dropping", h), this.Ub(), g = m;
                                    else g = m;
                                    g && (this.aa.Qc(c.map(h, function(a) {
                                        return a.id
                                    }), c.bind(function(a) {
                                        a ? (this.Ia = 0, this.flush()) : (this.h("Failed to remove items from queue"), 5 < ++this.Ia ? (this.h("Too many queue failures; disabling batching system."), this.fd()) : this.da())
                                    }, this)), c.a(h, c.bind(function(a) {
                                        var b = a.id;
                                        b ? (this.F[b] =
                                            this.F[b] || 0, this.F[b]++, 5 < this.F[b] && this.h("[dupe] item ID sent too many times", {
                                                item: a,
                                                C: h.length,
                                                kd: this.F[b]
                                    ...
                                    this.h("Error handling API response", n), this.da()
                                }
                            }, this),
                            k = {
                                method: "POST",
                        ...
                        if (a.fc) k.eb = "sendBeacon";
                        R.log("MIXPANEL REQUEST:", e);
                        this.Wc(e, k, i)
                    }
                }
            } catch (j) {
                this.h("Error flushing request queue", j), this.da()
            }
        };
        ...
        c.extend(v.prototype, B);
        v.prototype.W = function(a, b, c) {
            this.d = a;
            this.Ba = b;
            this.Aa = c
        };
        v.prototype.set = N(function(a, b, d) {
            var f = this.Xb(a, b);
            c.e(a) && (d = b);
            return this.k(f,
                d)
        });
        v.prototype.L = N(function(a, b, d) {
            var f = this.$b(a, b);
            c.e(a) && (d = b);
            return this.k(f, d)
        });
        v.prototype.va = N(function(a, b) {
            return this.k(this.gc(a), b)
        });
        v.prototype.fa = N(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.ec(a, b), d)
        });
        v.prototype["delete"] = N(function(a) {
            return this.k({
                $delete: ""
            }, a)
        });
        v.prototype.remove = N(function(a, b, c) {
            return this.k(this.Sb(a, b), c)
        });
        v.prototype.k = function(a, b) {
            ...
            return this.d.Ea({
                type: "groups",
                data: c.La(a),
                D: this.p("api_host") + "/" + this.p("api_routes").groups,
                Ga: this.d.u.Qa
            }, b)
        };
        ...
        v.prototype.toString = function() {
            return this.d.toString() + ".group." + this.Ba + "." + this.Aa
        };
        v.prototype.remove = v.prototype.remove;
        v.prototype.set = v.prototype.set;
        v.prototype.set_once = v.prototype.L;
        v.prototype.union = v.prototype.fa;
        v.prototype.unset = v.prototype.va;
        ...
        j.prototype.set = H(function(a, b, d) {
            var f = this.Xb(a, b);
            c.e(a) && (d = b);
            this.p("save_referrer") && this.d.persistence.fb(document.referrer);
            f.$set = c.extend({}, c.info.Pc(), f.$set);
            return this.k(f, d)
        });
        j.prototype.L = H(function(a, b, d) {
            var f = this.$b(a, b);
            c.e(a) && (d = b);
            return this.k(f, d)
        });
        j.prototype.va = H(function(a, b) {
            return this.k(this.gc(a), b)
        });
        j.prototype.Eb = H(function(a, b, d) {
            var f = {},
                e = {};
            c.e(a) ? (c.a(a, function(a, b) {
                this.z(b) || (isNaN(parseFloat(a)) ? s.error("Invalid increment value passed to mixpanel.people.increment - must be a number") :
                    e[b] = a)
        ...
        j.prototype.append = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.uc(a, b), d)
        });
        j.prototype.remove = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.Sb(a, b), d)
        });
        j.prototype.fa = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.ec(a, b), d)
        });
        j.prototype.nd = H(function(a, b, d) {
            if (!c.Hb(a) && (a = parseFloat(a), isNaN(a))) {
        ...
        j.prototype.k = function(a, b) {
            ...
            d = c.La(a);
            return !this.Ca() ? (this.oc(a), c.g(b) || (this.p("verbose") ? b({
                status: -1,
                error: q
            }) : b(-1)), c.truncate(d, 255)) : this.d.Ea({
                type: "people",
                data: d,
                D: this.p("api_host") + "/" + this.p("api_routes").engage,
                Ga: this.d.u.Ya
            }, b)
        };
        ...
        j.prototype.Ca = function() {
            return this.d.T.Cb === m
        };
        j.prototype.oc = function(a) {
            "$set" in a ? this.d.persistence.q("$set", a) : "$set_once" in a ? this.d.persistence.q("$set_once", a) : "$unset" in
                a ? this.d.persistence.q("$unset", a) : "$add" in a ? this.d.persistence.q("$add", a) : "$append" in a ? this.d.persistence.q("$append", a) : "$remove" in a ? this.d.persistence.q("$remove", a) : "$union" in a ? this.d.persistence.q("$union", a) : s.error("Invalid call to _enqueue():", a)
        };
        j.prototype.U = function(a, b, d, f) {
            var e = this,
                g = c.extend({}, this.d.persistence.Z(a)),
                p = g;
            !c.g(g) && c.e(g) && !c.qa(g) && (e.d.persistence.v(a, g), e.d.persistence.save(), f && (p = f(g)), b.call(e, p, function(b, f) {
                0 === b && e.d.persistence.q(a, g);
                c.g(d) || d(b, f)
            }))
        };
        j.prototype.pc = function(a, b, d, f, e, g, p) {
            var i = this;
            this.U("$set", this.set, a);
            this.U("$set_once", this.L, f);
            this.U("$unset", this.va, g, function(a) {
                return c.keys(a)
            });
            this.U("$add", this.Eb, b);
            this.U("$union", this.fa, e);
            a = this.d.persistence.Z("$append");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var k, b = function(a, b) {
                        0 === a && i.d.persistence.q("$append", k);
                        c.g(d) || d(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.Z("$append"), k = a.pop(), i.d.persistence.save(), c.qa(k) || i.append(k, b);
            a = this.d.persistence.Z("$remove");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var j, b = function(a, b) {
                        0 === a && i.d.persistence.q("$remove", j);
                        c.g(p) || p(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.Z("$remove"), j = a.pop(), i.d.persistence.save(), c.qa(j) || i.remove(j, b)
        };
        ...
        j.prototype.set_once = j.prototype.L;
        j.prototype.unset = j.prototype.va;
        j.prototype.increment = j.prototype.Eb;
        j.prototype.append =
            j.prototype.append;
        j.prototype.remove = j.prototype.remove;
        j.prototype.union = j.prototype.fa;
        j.prototype.track_charge = j.prototype.nd;
        j.prototype.clear_charges = j.prototype.rb;
        j.prototype.delete_user = j.prototype.zb;
        ...
        n.prototype.sd = function(a) {
            var b = a.upgrade,
                d;
            if (b) d = "mp_super_properties", "string" === typeof b && (d = b), b = this.i.parse(d), this.i.remove(d), this.i.remove(d, m), b && (this.props = c.extend(this.props, b.all, b.events));
            if (!a.cookie_name && "mixpanel" !== a.name && (d = "mp_" + a.token + "_" + a.name, b = this.i.parse(d))) this.i.remove(d), this.i.remove(d, m), this.w(b);
            this.i === c.localStorage && (b = c.cookie.parse(this.name), c.cookie.remove(this.name), c.cookie.remove(this.name,
                m), b && this.w(b))
        };
        n.prototype.save = function() {
            this.disabled || this.i.set(this.name, c.ga(this.props), this.Oa, this.Ja, this.Wb, this.xb, this.ma)
        };
        ...
        n.prototype.remove = function() {
            this.i.remove(this.name, D, this.ma);
            this.i.remove(this.name, m, this.ma)
        };
        ...
        n.prototype.w = function(a, b, d) {
            return c.e(a) ? ("undefined" === typeof b && (b = "None"), this.Oa = "undefined" === typeof d ? this.yb : d, this.load(), c.a(a, function(a,
                c) {
                if (!this.props.hasOwnProperty(c) || this.props[c] === b) this.props[c] = a
            }, this), this.save(), m) : D
        };
        n.prototype.m = function(a, b) {
            return c.e(a) ? (this.Oa = "undefined" === typeof b ? this.yb : b, this.load(), c.extend(this.props, a), this.save(), m) : D
        };
        ...
        n.prototype.fb = function(a) {
            this.w({
                ...
                $initial_referring_domain: c.info.Qb(a) || "$direct"
            }, "")
        };
        n.prototype.Fc =
            function() {
        ...
        n.prototype.hc = function(a) {
            this.yb = this.Oa = a.cookie_expiration;
            this.Zb(a.disable_persistence);
            this.Zc(a.cookie_domain);
            this.$c(a.cross_site_cookie);
            this.ad(a.cross_subdomain_cookie);
            this.dd(a.secure_cookie)
        };
        n.prototype.Zb = function(a) {
            (this.disabled = a) ? this.remove(): this.save()
        };
        n.prototype.Zc = function(a) {
            if (a !== this.ma) this.remove(), this.ma = a, this.save()
        };
        n.prototype.$c =
            function(a) {
                if (a !== this.xb) this.xb = a, this.remove(), this.save()
            };
        n.prototype.ad = function(a) {
            if (a !== this.Ja) this.Ja = a, this.remove(), this.save()
        };
        n.prototype.Dc = function() {
            return this.Ja
        };
        n.prototype.dd = function(a) {
            if (a !== this.Wb) this.Wb = a ? m : D, this.remove(), this.save()
        };
        n.prototype.q = function(a, b) {
            var d = this.ia(a),
                ...
                j = this.B("$remove", []),
                n = this.B("$append", []);
            "__mps" === d ? (c.extend(e, f), this.v("$add",
                    f), this.v("$union", f), this.v("$unset", f)) : "__mpso" === d ? (c.a(f, function(a, b) {
                    b in g || (g[b] = a)
                ...
                }), this.v("$unset", f)) : "__mpr" === d ? (j.push(f), this.v("$append", f)) : "__mpap" ===
                d && (n.push(f), this.v("$unset", f));
            s.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");
            s.log(b);
            this.save()
        };
        n.prototype.v = function(a, b) {
            var d = this.props[this.ia(a)];
        ...
        n.prototype.Rc = function(a) {
            var b = (this.sa("__timers") || {})[a];
            c.g(b) || (delete this.props.__timers[a], this.save());
            return b
        };
        var ca, y, O = o.XMLHttpRequest && "withCredentials" in
            new XMLHttpRequest,
        ...
        e.prototype.Ta = function(a, b, d) {
            ...
            else return a = S(a, b, d), y[d] = a, a.ja(), a
        };
        e.prototype.W = function(a, b, d) {
            ...
            this.config = {};
            var e = {};
            "api_payload_format" in b || (b.api_host || za.api_host).match(/\.mixpanel\.com/) &&
                (e.api_payload_format = "json");
            this.Yb(c.extend({}, za, e, b, {
                name: d,
                token: a,
            ...
            this.u = {};
            if (this.S = this.c("batch_requests"))
                if (!c.localStorage.ra(m) || !O) this.S = D, s.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"), c.a(this.Bb(), function(a) {
                    s.log("Clearing batch queue " + a.ba);
                    c.localStorage.remove(a.ba)
                });
                else if (this.Hc(), ba &&
                o.addEventListener) {
                var h = c.bind(function() {
                    this.u.J.ua || this.u.J.flush({
                        fc: m
                    })
                }, this);
            ...
            (a = this.c("track_pageview")) && this.rc(a)
        };
        e.prototype.ja = function() {
            this.c("loaded")(this);
            this.pb();
            this.people.L(this.persistence.Fc());
        ...
        e.prototype.pb = function() {
            this.persistence.ic(w.referrer);
            this.c("store_google") && !this.c("stop_utm_persistence") && this.m(c.info.X());
            this.c("save_referrer") && this.persistence.fb(w.referrer)
        };
        e.prototype.nc = function() {
            c.a(this.xa, function(a) {
                this.Da.apply(this, a)
            }, this);
            this.Y() || c.a(this.ya, function(a) {
                this.k.apply(this, a)
            }, this);
            delete this.xa;
            delete this.ya
        ...
        e.prototype.Da =
            function(a, b) {
                ...
                if (!la) return this.xa.push([a, b]), D;
                var c = (new a).Ta(this);
        ...
        e.prototype.rc = function(a) {
            var b = "";
            this.cb() && (b = c.info.Ka());
            if (c.Sa(["full-url", "url-with-path-and-query-string", "url-with-path"], a)) {
                ...
                var e = o.history.replaceState;
                if ("function" === typeof e) o.history.replaceState = function(a, b, c) {
                    e.call(o.history, a, b, c);
                    o.dispatchEvent(new Event("mp_locationchange"))
                };
                o.addEventListener("mp_locationchange", function() {
                    var d = c.info.Ka(),
                        e = D;
                    "full-url" === a ? e = d !== b : "url-with-path-and-query-string" === a ? e = d.split("#")[0] !== b.split("#")[0] : "url-with-path" ===
                        a && (e = d.split("#")[0].split("?")[0] !== b.split("#")[0].split("?")[0]);
                    e && this.cb() && (b = d)
                }.bind(this))
            }
        };
        e.prototype.mb = function(a, b) {
            if (c.g(a)) return q;
        ...
        e.prototype.k = function(a, b, d, e) {
            var h = m;
            if (ma) return this.ya.push(arguments), h;
            var g = {
                    method: this.c("api_method"),
                    eb: this.c("api_transport"),
                    jc: this.c("verbose")
                },
                j = q;
            if (!e && (c.Ua(d) || "string" ===
            ...
            if (!O) d.method = "GET";
            var g = "POST" === d.method,
                i = ba && g && "sendbeacon" === d.eb.toLowerCase(),
                k = d.jc;
            b.verbose && (k = m);
            ...
            var a = a + ("?" + c.kc(b)),
                n = this;
            if ("img" in b) j = w.createElement("img"), j.src = a, w.body.appendChild(j);
            else if (i) {
                try {
                    h = ba(a, j)
                } catch (o) {
                ...
                u.open(d.method, a, m);
                var v = this.c("xhr_headers");
                g && (v["Content-Type"] = "application/x-www-form-urlencoded");
                c.a(v, function(a, b) {
                    u.setRequestHeader(b, a)
                });
                if (d.cc && "undefined" !== typeof u.timeout) {
                    u.timeout = d.cc;
                        ...
                        if (200 === u.status) {
                            if (e)
                                if (k) {
                                    var a;
                                    try {
                                        a = c.R(u.responseText)
                                    } catch (b) {
                                        if (n.l(b),
                                            d.Gc) a = u.responseText;
                                        else return
                                    }
                                    e(a)
                                } else e(Number(u.responseText))
                        } else a = u.timeout && !u.status && (new Date).getTime() - y >= u.timeout ? "timeout" : "Bad HTTP status: " + u.status + " " + u.statusText, n.l(a), e && (k ? e({
                            status: 0,
                            error: a,
                            Q: u
                        }) : e(0))
                ...
                n.l(z), h = D
            } else j = w.createElement("script"), j.type = "text/javascript", j.async = m, j.defer = m, j.src = a, v = w.getElementsByTagName("script")[0], v.parentNode.insertBefore(j, v);
            return h
        };
        ...
        e.prototype.Hc = function() {
            if (!this.qb()) {
                var a = c.bind(function(a) {
                        return new C(a.ba, {
                            A: this.config,
                            Xc: c.bind(function(b, c, e) {
                                this.k(this.c("api_host") + a.D, this.kb(b), c, this.mb(e, b))
                            }, this),
                            ka: c.bind(function(b) {
                                return this.ob("before_send_" + a.type, b)
                            }, this),
                            I: this.c("error_reporter"),
                            gd: c.bind(this.ab, this)
                        })
                    }, this),
                    b = this.Bb();
                this.u = {
            ...
            this.c("batch_autostart") && this.$a()
        };
        e.prototype.$a = function() {
            this.lc = m;
            if (this.qb()) this.S = m, c.a(this.u, function(a) {
                a.start()
            })
        };
        ...
        e.prototype.disable = function(a) {
            "undefined" === typeof a ? this.T.yc = m : this.wa = this.wa.concat(a)
        };
        e.prototype.kb = function(a) {
            a = c.ga(a);
            "base64" === this.c("api_payload_format") && (a = c.vc(a));
            return {
                data: a
            }
        };
        e.prototype.Ea = function(a, b) {
            var d =
                ...
                i = m,
                k = c.bind(function() {
                    j.ac || (d = this.ob("before_send_" + a.type, d));
                    return d ? (s.log("MIXPANEL REQUEST:"), s.log(d), this.k(e, this.kb(d), j, this.mb(b, d))) : q
                }, this);
            this.S && !g ? h.Ma(d, function(a) {
                a ? b(1, d) : k()
            }) : i = k();
            return i && d
        };
        e.prototype.o = M(function(a, b, d, e) {
            ...
            if (c.g(a)) this.l("No event name provided to mixpanel.track");
            else if (this.lb(a)) e(0);
            else {
                b = c.extend({}, b);
                b.token = this.c("token");
                var g = this.persistence.Rc(a);
                c.g(g) || (b.$duration = parseFloat((((new Date).getTime() - g) / 1E3).toFixed(3)));
                this.pb();
                g = this.c("track_marketing") ? c.info.Lc() : {};
                b = c.extend({}, c.info.$({
                    mp_loader: this.c("mp_loader")
                }), g, this.persistence.$(), this.O, b);
                ...
                return this.Ea({
                    ...
                    D: this.c("api_host") + "/" + this.c("api_routes").track,
                    Ga: this.u.J,
                    ed: h,
                    Yc: d
                }, e)
        ...
        e.prototype.cd = M(function(a, b, d) {
            c.isArray(b) || (b = [b]);
            var e = {};
            e[a] = b;
            this.m(e);
        ...
        e.prototype.sc = M(function(a, b, c) {
            var e = this.s(a),
                h = {};
            e === l ? (h[a] = [b], this.m(h)) : -1 === e.indexOf(b) && (e.push(b), h[a] = e, this.m(h));
            return this.people.fa(a, b, c)
        });
        e.prototype.Sc = M(function(a, b, c) {
            var e = this.s(a);
            if (e !== l) {
            ...
            return this.people.remove(a,
                b, c)
        });
        e.prototype.qd = M(function(a, b, d, e) {
            var h = c.extend({}, b || {});
            c.a(d, function(a, b) {
                a !== q && a !== l && (h[b] = a)
            });
        ...
        e.prototype.mc = function(a, b) {
            return a + "_" + JSON.stringify(b)
        };
        e.prototype.Ec = function(a, b) {
            var c = this.mc(a, b),
                e = this.jb[c];
            if (e === l || e.Ba !== a || e.Aa !== b) e = new v, e.W(this, a, b), this.jb[c] = e;
            return e
        };
        e.prototype.cb = M(function(a, b) {
            "object" !== typeof a && (a = {});
            var b = b || {},
                d = b.event_name || "$mp_web_page_view",
                e = c.extend(c.info.Mc(), c.info.X(), c.info.tb()),
                e = c.extend({}, e,
                    a);
            return this.o(d, e)
        });
        e.prototype.pd = function() {
            return this.Da.call(this, L, arguments)
        };
        e.prototype.od = function() {
            return this.Da.call(this, T, arguments)
        };
        e.prototype.jd = function(a) {
            c.g(a) ? this.l("No event name provided to mixpanel.time_event") : this.lb(a) || this.persistence.bd(a)
        };
        var Da = {
            persistent: m
        };
        e.prototype.m = function(a, b) {
            var d = da(b);
            d.persistent ? this.persistence.m(a, d.days) : c.extend(this.O, a)
        };
        e.prototype.w = function(a, b, d) {
            d = da(d);
            d.persistent ? this.persistence.w(a, b, d.days) : ("undefined" ===
                typeof b && (b = "None"), c.a(a, function(a, c) {
                    if (!this.O.hasOwnProperty(c) || this.O[c] === b) this.O[c] = a
                }, this))
        };
        e.prototype.P = function(a, b) {
            b = da(b);
            b.persistent ? this.persistence.P(a) : delete this.O[a]
        };
        ...
        e.prototype.Ra = function(a, b, c, e, h, g, j, i) {
            var k = this.K();
            if (a && k !== a) {
            ...
            a !== k && a !== this.s("__alias") && (this.P("__alias"), this.m({
                distinct_id: a
            }));
            this.T.Cb = m;
            this.people.pc(b, c, e, h, g, j, i);
            a !== k && this.o("$identify", {
                distinct_id: a,
                $anon_distinct_id: k
            }, {
        ...
        e.prototype.tc = function(a, b) {
            ...
            var d = this;
            c.g(b) && (b = this.K());
            if (a !== b) return this.nb("__alias", a), this.o("$create_alias", {
                alias: a,
                distinct_id: b
            }, {
                ac: m
        ...
        e.prototype.Nc = function(a) {
            this.nb("mp_name_tag", a)
        };
        e.prototype.Yb = function(a) {
            if (c.e(a)) c.extend(this.config, a), a.batch_size && c.a(this.u, function(a) {
                    a.Ub()
                }), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") ||
                (this.config.disable_persistence = this.config.disable_cookie), this.persistence && this.persistence.hc(this.config), J = J || this.c("debug")
        };
        ...
        e.prototype.lb = function(a) {
            return c.Gb(A) || this.T.yc || c.Sa(this.wa, a)
        };
        e.prototype.qc = function() {
            "localStorage" === this.c("opt_out_tracking_persistence_type") && c.localStorage.ra() && (!this.pa() && this.pa({
            ...
            else if (!this.pa() && (this.c("opt_out_tracking_by_default") ||
                    c.cookie.get("mp_optout"))) c.cookie.remove("mp_optout"), this.Xa({
        ...
        e.prototype.ha = function(a) {
            ...
            !this.c("disable_persistence") && this.persistence.disabled !== a && this.persistence.Zb(a);
            a ? this.ab() : this.lc && this.$a()
        };
        e.prototype.V = function(a, b) {
            ...
            c.localStorage.ra() || (b.persistence_type = "cookie");
            return a(this.c("token"), {
                o: b.track,
                ld: b.track_event_name,
                md: b.track_properties,
                Ob: b.persistence_type,
                Nb: b.cookie_prefix,
                ub: b.cookie_domain,
                vb: b.cookie_expiration,
                xc: b.cross_site_cookie,
                wb: b.cross_subdomain_cookie,
                Vc: b.secure_cookie,
                Db: b.ignore_dnt
            })
        };
        ...
        e.prototype.Xa = function(a) {
            ...
            a.delete_user && this.people && this.people.Ca() && (this.people.zb(), this.people.rb());
            this.V(Ia, a);
            this.ha(a)
        };
        ...
        e.prototype.init = e.prototype.Ta;
        e.prototype.reset = e.prototype.reset;
        e.prototype.disable = e.prototype.disable;
        e.prototype.time_event = e.prototype.jd;
        e.prototype.track = e.prototype.o;
        e.prototype.track_links = e.prototype.pd;
        e.prototype.track_forms = e.prototype.od;
        e.prototype.track_pageview = e.prototype.cb;
        e.prototype.register = e.prototype.m;
        e.prototype.register_once =
            e.prototype.w;
        e.prototype.unregister = e.prototype.P;
        e.prototype.identify = e.prototype.Ra;
        e.prototype.alias = e.prototype.tc;
        e.prototype.name_tag = e.prototype.Nc;
        e.prototype.set_config = e.prototype.Yb;
        e.prototype.get_config = e.prototype.c;
        e.prototype.get_property = e.prototype.s;
        e.prototype.get_distinct_id = e.prototype.K;
        e.prototype.toString = e.prototype.toString;
        e.prototype.opt_out_tracking = e.prototype.Xa;
        e.prototype.opt_in_tracking = e.prototype.Kb;
        e.prototype.has_opted_out_tracking = e.prototype.Y;
        e.prototype.has_opted_in_tracking =
            e.prototype.pa;
        e.prototype.clear_opt_in_out_tracking = e.prototype.sb;
        e.prototype.get_group = e.prototype.Ec;
        e.prototype.set_group = e.prototype.cd;
        e.prototype.add_group = e.prototype.sc;
        e.prototype.remove_group = e.prototype.Sc;
        e.prototype.track_with_groups = e.prototype.qd;
        e.prototype.start_batch_senders = e.prototype.$a;
        e.prototype.stop_batch_senders = e.prototype.ab;
        e.prototype.DEFAULT_API_ROUTES = B;
        n.prototype.properties = n.prototype.$;
        n.prototype.update_search_keyword = n.prototype.ic;
        n.prototype.update_referrer_info =
            n.prototype.fb;
        n.prototype.get_cross_subdomain = n.prototype.Dc;
        n.prototype.clear = n.prototype.clear;
        var F = {};
        (function() {
            ca = 1;
            y = o.mixpanel;
            c.g(y) ? s.H('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.') : y.__loaded || y.config && y.persistence ? s.H("The Mixpanel library has already been downloaded at least once. Ensure that the Mixpanel code snippet only appears once on the page (and is not double-loaded by a tag manager) in order to avoid errors.") :
                1.1 > (y.__SV || 0) ? s.H("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet.") : (c.a(y._i, function(a) {
